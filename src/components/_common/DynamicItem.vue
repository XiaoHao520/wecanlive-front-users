<template>
  <div class="component-live-item">
    <div class="live-title">直播标题</div>
    <div class="live-member-num">10086</div>
    ...
    <div class="bottom-block">
      ...
      <div class="btn-bar">
        ...
        <a class="bot-btn bot-btn-share"></a>
    ...
    .bottom-block {
      ...
      .btn-bar {
        ...
        .bot-btn {
          ...
          &.bot-btn-comment {
            background: url("../../assets/image/B1/icon_comment_nor@3x.png") 50% 50% no-repeat;
            -webkit-background-size: 100%;
            background-size: 100%;
          }
          &.bot-btn-share {
            background: url("../../assets/image/B1/icon_share_nor@3x.png") 50% 50% no-repeat;
            -webkit-background-size: 100%;
            background-size: 100%;
          }
        }
